...
import { Calendar as CalendarIcon, Check, ChevronsUpDown, CircleAlert } from 'lucide-react';
import { useForm } from 'react-hook-form';
import * as z from 'zod';
import { formSchema } from '@/validation/time-line-form';
		...
		<AlertDialog>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>This action cannot be undone. This will cancel your event and remove it from the calendar.</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
	...
	return (
		<Form {...form}>
			<form
				...
				className="w-full px-2 py-4 mx-auto space-y-4 lg:py-0">
				<div className="grid items-baseline grid-cols-2 gap-4">
													...
													<CommandGroup>
														{halls.map((hall) => (
															<CommandItem
																...
																<Check className={cn('mr-2 h-4 w-4', hall.value === field.value ? 'opacity-100' : 'opacity-0')} />
																{hall.label}
															</CommandItem>
														))}
													</CommandGroup>
				...
				<div className="grid items-baseline justify-center grid-cols-12 gap-4">
					<div className="col-span-6">
						<FormField
							control={form.control}
							name="startdate"
