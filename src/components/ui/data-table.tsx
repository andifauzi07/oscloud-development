...
const EditableCell = ({ value: initialValue, row: { index }, column: { id }, updateData, isEditable }: EditableCellProps) => {
...
export function DataTable<TData, TValue>({ columns, data, loading = false, enableRowDragAndDrop = false, enableColumnDragAndDrop = false, isEditable = false, nonEditableColumns = [], onSave }: DataTableProps<TData, TValue>) {
	...
	useEffect(() => {
		...
		const editableColumns = columns.map((col) => ({
			...
			cell: (props: CellContext<TData, TValue>) => {
				...
				if (!shouldEdit || props.column.id === 'actions' || props.column.id === 'profileimage') {
