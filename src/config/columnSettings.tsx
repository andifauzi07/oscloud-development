            ...
            cell: ({ row }) => (
                <div className="flex justify-end w-full">
                    <div className="sticky right-0 bg-white">
                        <Button variant="outline" className="w-20 border ">
                            <Link
...
export const defaultPaymentColumnSettings: BaseColumnSetting<any>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const rate =
                employee?.rates?.find((r) => r.type === "A")?.ratevalue ||
                employee?.rates?.find((r) => r.type === "B")?.ratevalue ||
                0;
            return `¥${rate}`;
        },
    },
...

    {
        ...
        cell: ({ row }) => {
            ...
            const projectId =
                ...
                row.original?.project?.projectId ||
                "";
    ...
    [
        {
            ...
            order: 1,
            cell: ({ row }) => (
                <h1 className="py-2 pl-8">{row.original.projectName}</h1>
            ),
        },
        {
            accessorKey: "manager",
