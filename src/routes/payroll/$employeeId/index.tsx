        ...
        <div className="flex flex-col flex-1 h-full">
            ...
            <Tabs defaultValue="profile">
                    ...
                    <div className="h-full">
                        <div className="flex flex-col">
                            <div className="bg-white border-r">
                                <h2 className="container px-4 py-2">{employeeData?.name}</h2>
                            </div>
                ...
                <TabsContent
                    ...
                    <div className="flex w-full px-6 py-4 bg-white border-r">
                ...
                <TabsContent
                    ...
                    <div className="flex justify-between w-full px-6 py-4 bg-white border-r">
