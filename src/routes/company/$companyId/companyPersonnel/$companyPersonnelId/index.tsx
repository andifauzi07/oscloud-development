...
function RouteComponent() {
    ...
    const personnel = mockEmployees.find(
        (emp) => emp.id === parseInt(companyPersonnelId)
    );
    const company =
        personnel ?
    ...
    const [boards, setBoards] = useState([
        {
            ...
            color: "bg-blue-500",
            leads:
                personnel?.leads.filter((lead) => lead.status === "active") ||
                [],
        },
        {
            id: "completed",
        ...
        },
        {
            ...
            color: "bg-yellow-500",
            leads:
                personnel?.leads.filter((lead) => lead.status === "pending") ||
                [],
        },
    ]);
    ...
    return (
        <div className="flex-1 h-full">
            ...
            <div className="flex justify-end flex-none w-full bg-white">
                <Button className="w-1/2 text-black bg-transparent border md:w-20 min-h-14">
                    EDIT
                </Button>
            </div>
