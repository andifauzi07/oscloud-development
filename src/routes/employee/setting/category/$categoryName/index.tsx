...
function RouteComponent() {
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            {/* Description Section */}
            <div className="flex items-center w-full px-4 py-2 bg-gray-100 border-b">
                <h1>Description</h1>
                <div className="flex justify-end w-full px-2">
                    <Button className="w-20 text-black bg-transparent border link">
                        EDIT
                    </Button>
                </div>
            </div>
            ...
            <div className="flex w-full gap-40 px-4 py-4 bg-white border-b item-center">
                <h1>Category name</h1>
                <h1>Category A</h1>
            </div>
