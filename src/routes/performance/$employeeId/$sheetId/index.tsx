		...
		<div className="flex flex-col h-full">
			...
			<div className="flex justify-end flex-none bg-white">
				<Button
					...
					className="w-20 text-black bg-transparent border-r border-l cursor-pointer h-10">
					{isEditing ? 'SAVE' : 'EDIT'}
				</Button>
			</div>
			...
			<div className="grid h-full grid-cols-2">
				{/* Score Chart Section */}
				<Card className="flex border-l-0 flex-col h-full rounded-none">
							...
							{category.points.map((point) => (
								<div
									...
									<div className="flex items-center">
										...
										<div className="w-20 p-4 text-center border-r border-t border-l">{point.weight}</div>
									</div>
								</div>
							))}
						</div>
